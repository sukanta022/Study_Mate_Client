            ...
            <form className="bg-[#131B34] p-6 md:p-10 rounded-3xl border-2 border-[#202751] space-y-6 w-full max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <fieldset className="fieldset">
                        ...
                        <input type="text"  placeholder="e.g., Mathematics, Physics, Computer Science" className="input input-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full" />
                    </fieldset>

                    <fieldset className="fieldset">
                        <label className="text-white label">Study Mode</label>
                        <select className="select bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <fieldset className="fieldset">
                        ...
                        <input type="text" placeholder="e.g., New York" className="input input-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full" />
                    </fieldset>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <fieldset className="fieldset">
                        ...
                        <input type="text" placeholder="e.g., English, Spanish" className="input input-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full"  />
                    </fieldset>

                    <fieldset className="fieldset">
                        <label className="text-white label">Availability</label>
                        <input type="text" placeholder="e.g., Evening 6–9 PM" className="input input-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full" />
                    </fieldset>
                </div>
                ...
                <fieldset className="fieldset">
                    ...
                    <textarea placeholder="Describe your key skills and area of expertise"className="textarea textarea-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full min-h-[120px]"/>
                </fieldset>

                <fieldset className="fieldset">
                    <label className="text-white label">About You</label>
                    <textarea placeholder="Tell potential study partners about yourself and your teaching style" className="textarea textarea-info bg-[#0F172A] text-white border-[#262D62] focus:border-[#9F62F2] focus:outline-none w-full min-h-[140px]"/>
                </fieldset>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <button className="btn w-full md:w-1/4 bg-[#2A3148] text-white font-semibold text-xl rounded-xl">Clear</button>
                </div>
